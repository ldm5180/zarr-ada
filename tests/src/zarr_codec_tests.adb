...
package body Zarr_Codec_Tests is
   ...
   begin
      ...
      Assert (Zarr.Codec.Decode_I4 ([16#FF#, 16#FF#, 16#FF#, 16#FF#]) = -1,
   ...
   begin
      ...
      Assert (Zarr.Codec.Decode_I8 ([0, 0, 0, 0, 1, 0, 0, 0]) = 4_294_967_296,
              "2**32 spans the low/high words");
      Assert (Zarr.Codec.Decode_I8
                ([16#FF#, 16#FF#, 16#FF#, 16#FF#,
                  16#FF#, 16#FF#, 16#FF#, 16#FF#]) = -1, "all ones is -1");
   end Test_Decode_I8;
   ...
   begin
      ...
      Assert (Zarr.Codec.Decode_F4 ([16#00#, 16#00#, 16#C0#, 16#3F#]) = 1.5,
              "1.5");
      Assert (Zarr.Codec.Decode_F4 ([16#00#, 16#00#, 16#10#, 16#C0#]) = -2.25,
              "-2.25");
   end Test_Decode_F4;
   ...
   begin
      ...
      Assert (not (Q = Zero) and not (Q < Zero) and not (Q > Zero),
              "Quiet_NaN is a NaN");
      Assert (not (D = Zero) and not (D < Zero) and not (D > Zero),
